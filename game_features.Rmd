...
ggsave("cum_model_error_season.jpg",path = paste0(wd,"/img/"), units = 'in',width = 8, height = 8, device='jpg', dpi=700)
```
...
```
## Run some statistical tests to compare MAE to the market spread.
...
```{r}
cur_wk <- game_w_features %>% filter(week == 17 & season == 2020)
